    ...
    try {
        ...
        const completion = await openai.chat.completions.create({
            ...
            messages: [
                ...
                {
                    role: "user",
                    content: `Give me a short fun motivational message for these habits: ${habits.join(", ")}. Keep it under 50 words.`,
                },
            ],
            max_tokens: 100,
        });
        ...
        res.json({
            message: `You're doing great with your habits! 💪 Keep up with ${req.body.habits.join(", ")}, and stay consistent 🌱`,
            source: "fallback",
        });
    }
});
